...
```bash
docker pull sameersbn/apt-cacher-ng:3.7.4-24.04
```
...
docker run --name apt-cacher-ng --init -d --restart=always \
  ...
  sameersbn/apt-cacher-ng:3.7.4-24.04
```
...
docker run --name apt-cacher-ng --init -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  sameersbn/apt-cacher-ng:3.7.4-24.04 -h
```
...
docker run --name apt-cacher-ng --init -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  sameersbn/apt-cacher-ng:3.7.4-24.04 -e
```
